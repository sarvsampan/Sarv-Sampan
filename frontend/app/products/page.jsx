...
export default function ProductsPage() {
  ...
  useEffect(() => {
    fetchProducts();
  }, [searchParams, selectedCategories, minPrice, maxPrice, inStock, sortBy, currentPage]);
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      if (selectedCategories.length > 0) {
        params.append('category', selectedCategories[0]); // For now, single category
      }
      ...
      // Add in stock filter
      if (inStock) {
        // We'll filter on frontend for now since backend doesn't have this param
      }
      ...
      // Add featured filter from URL params
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_USER_API_URL}/products?${params.toString()}`);
        ...
        <div className="flex gap-6">
          ...
          >
            ...
            >
              ...
              {/* Categories */}
              <div className="mb-6 pb-6 border-b border-slate-200">
                <h3 className="font-semibold text-sm text-slate-900 mb-3">Categories</h3>
