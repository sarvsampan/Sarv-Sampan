      ...
      <main className="container mx-auto px-4 py-16 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-8 mb-6">
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                ...
                <p className="text-sm font-bold text-slate-900 capitalize">
                  {orderData.payment_method === 'cod' ? 'Cash on Delivery' :
                   orderData.payment_method === 'razorpay' || orderData.payment_method === 'online' ? 'Online Payment' :
                   orderData.payment_method}
                </p>
                {orderData.payment_status === 'paid' && (
                  <div className="mt-2 flex items-center gap-1">
                    <CheckCircle className="w-3 h-3 text-emerald-600" />
                    <span className="text-xs text-emerald-600 font-semibold">Payment Successful</span>
                  </div>
                )}
              </div>
              <div className="bg-slate-50 rounded-lg p-4">
            ...
            {orderData.payment_status === 'paid' && orderData.razorpay_payment_id && (
              <div className="bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-emerald-900 mb-1">Payment Confirmed ✓</p>
