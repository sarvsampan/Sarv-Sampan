...
\restrict zmdIAvBHxo8I3pECfS7SqbpY62zo6EoE6mJhMztQ5w6EbB6aeWJJVGOA4OZ9GZS
...
--
-- Name: decrement_helpful_count(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.decrement_helpful_count(review_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE review
...
ALTER FUNCTION public.decrement_helpful_count(review_id uuid) OWNER TO postgres;

--
-- Name: increment_helpful_count(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.increment_helpful_count(review_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE review
...
ALTER FUNCTION public.increment_helpful_count(review_id uuid) OWNER TO postgres;
...
--
-- Name: update_replacement_requests_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_replacement_requests_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.update_replacement_requests_updated_at() OWNER TO postgres;

--
-- Name: update_return_requests_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_return_requests_updated_at() OWNER TO postgres;
...
COMMENT ON TABLE public.cart_items IS 'Stores user cart items (supports both logged-in and guest users)';
...
ALTER SEQUENCE public.deal_products_id_seq OWNER TO postgres;
...
--
-- Name: helpful_reviews; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.helpful_reviews OWNER TO postgres;

--
-- Name: TABLE helpful_reviews; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.helpful_reviews IS 'Tracks which users found reviews helpful';
...
--
-- Name: replacement_items; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.replacement_items OWNER TO postgres;

--
-- Name: replacement_requests; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.replacement_requests OWNER TO postgres;

--
-- Name: TABLE replacement_requests; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.replacement_requests IS 'Customer product replacement requests';


--
-- Name: COLUMN replacement_requests.status; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.replacement_requests.status IS 'Request status: pending, approved, rejected, completed, shipped';


--
-- Name: COLUMN replacement_requests.images; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.replacement_requests.images IS 'Array of image URLs uploaded by customer for replacement request';
...
CREATE TABLE public.replacements (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    replacement_number character varying(50) NOT NULL,
    order_id uuid NOT NULL,
    user_id uuid NOT NULL,
    reason text NOT NULL,
    description text,
    status character varying(50) DEFAULT 'pending'::character varying,
    replacement_method character varying(50),
    admin_notes text,
    images jsonb,
    approved_by uuid,
    processed_at timestamp without time zone,
...
--
-- Name: TABLE return_requests; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.return_requests IS 'Customer return/refund requests';


--
-- Name: COLUMN return_requests.status; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.return_requests.status IS 'Request status: pending, approved, rejected, completed';


--
-- Name: COLUMN return_requests.images; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.return_requests.images IS 'Array of image URLs uploaded by customer for return request';
...
COMMENT ON TABLE public.review IS 'User product reviews and ratings';
...
COMMENT ON COLUMN public.review.rating IS 'Product rating from 1 to 5 stars';


--
-- Name: COLUMN review.verified_purchase; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.review.verified_purchase IS 'True if review is from verified purchase (user bought this product)';


--
-- Name: COLUMN review.helpful_count; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.review.helpful_count IS 'Number of users who found this review helpful';
...
--
-- Name: TABLE review_images; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.review_images IS 'Images uploaded with product reviews (max 5 per review)';
...
COMMENT ON TABLE public.wishlist_items IS 'Stores user wishlist items (logged-in users only)';
...
--
-- Name: deal_products deal_products_deal_id_product_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: helpful_reviews helpful_reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.helpful_reviews
    ADD CONSTRAINT helpful_reviews_pkey PRIMARY KEY (id);


--
-- Name: helpful_reviews helpful_reviews_review_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.helpful_reviews
    ADD CONSTRAINT helpful_reviews_review_id_user_id_key UNIQUE (review_id, user_id);
...
--
-- Name: replacement_items replacement_items_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_items
    ADD CONSTRAINT replacement_items_pkey PRIMARY KEY (id);


--
-- Name: replacement_requests replacement_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: replacements replacements_replacement_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacements
    ADD CONSTRAINT replacements_replacement_number_key UNIQUE (replacement_number);
...
--
-- Name: returns returns_return_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: review review_product_id_user_id_order_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.review
    ADD CONSTRAINT review_product_id_user_id_order_id_key UNIQUE (product_id, user_id, order_id);
...
--
-- Name: cart_items unique_session_product; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: wishlist_items unique_user_wishlist; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.wishlist_items
    ADD CONSTRAINT unique_user_wishlist UNIQUE (user_id, product_id);
...
--
-- Name: idx_cart_session_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_coupon_usage_order_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deal_products_deal_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deal_products_product_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deals_dates; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_deals_dates ON public.deals USING btree (start_date, end_date);


--
-- Name: idx_deals_is_active; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_deals_is_active ON public.deals USING btree (is_active);


--
-- Name: idx_helpful_reviews_review_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_helpful_reviews_review_id ON public.helpful_reviews USING btree (review_id);


--
-- Name: idx_helpful_reviews_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_helpful_reviews_user_id ON public.helpful_reviews USING btree (user_id);
...
--
-- Name: idx_orders_coupon_code; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_orders_paid_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_replacement_items_replacement_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacement_items_replacement_id ON public.replacement_items USING btree (replacement_id);


--
-- Name: idx_replacement_requests_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacement_requests_created_at ON public.replacement_requests USING btree (created_at DESC);


--
-- Name: idx_replacement_requests_order_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacement_requests_order_id ON public.replacement_requests USING btree (order_id);


--
-- Name: idx_replacement_requests_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacement_requests_status ON public.replacement_requests USING btree (status);


--
-- Name: idx_replacement_requests_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacement_requests_user_id ON public.replacement_requests USING btree (user_id);


--
-- Name: idx_replacements_order_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacements_order_id ON public.replacements USING btree (order_id);


--
-- Name: idx_replacements_replacement_number; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacements_replacement_number ON public.replacements USING btree (replacement_number);


--
-- Name: idx_replacements_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacements_status ON public.replacements USING btree (status);


--
-- Name: idx_replacements_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_replacements_user_id ON public.replacements USING btree (user_id);
...
--
-- Name: idx_return_requests_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_return_requests_created_at ON public.return_requests USING btree (created_at DESC);


--
-- Name: idx_return_requests_order_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_return_requests_user_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_returns_order_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_returns_return_number; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_returns_return_number ON public.returns USING btree (return_number);
...
--
-- Name: idx_review_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_review_created_at ON public.review USING btree (created_at DESC);


--
-- Name: idx_review_helpful_count; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_review_helpful_count ON public.review USING btree (helpful_count DESC);
...
--
-- Name: idx_users_oauth_provider; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: replacement_requests replacement_requests_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER replacement_requests_updated_at BEFORE UPDATE ON public.replacement_requests FOR EACH ROW EXECUTE FUNCTION public.update_replacement_requests_updated_at();


--
-- Name: return_requests return_requests_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
CREATE TRIGGER review_updated_at BEFORE UPDATE ON public.review FOR EACH ROW EXECUTE FUNCTION public.update_review_updated_at();


--
-- Name: review update_product_rating_on_review_change; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_product_rating_on_review_change AFTER INSERT OR DELETE OR UPDATE ON public.review FOR EACH ROW EXECUTE FUNCTION public.update_product_rating();
...
--
-- Name: deal_products deal_products_deal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: deal_products deal_products_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.categories
    ADD CONSTRAINT fk_parent FOREIGN KEY (parent_id) REFERENCES public.categories(id);
...
--
-- Name: reviews fk_product_review; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT fk_product_review FOREIGN KEY (product_id) REFERENCES public.products(id);


--
-- Name: addresses fk_user_address; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.addresses
    ADD CONSTRAINT fk_user_address FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT fk_user_review FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: helpful_reviews helpful_reviews_review_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.helpful_reviews
    ADD CONSTRAINT helpful_reviews_review_id_fkey FOREIGN KEY (review_id) REFERENCES public.review(id) ON DELETE CASCADE;


--
-- Name: helpful_reviews helpful_reviews_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.helpful_reviews
    ADD CONSTRAINT helpful_reviews_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: replacement_items replacement_items_order_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_items
    ADD CONSTRAINT replacement_items_order_item_id_fkey FOREIGN KEY (order_item_id) REFERENCES public.order_items(id);


--
-- Name: replacement_items replacement_items_replacement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_items
    ADD CONSTRAINT replacement_items_replacement_id_fkey FOREIGN KEY (replacement_id) REFERENCES public.replacements(id) ON DELETE CASCADE;


--
-- Name: replacement_requests replacement_requests_new_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_requests
    ADD CONSTRAINT replacement_requests_new_order_id_fkey FOREIGN KEY (new_order_id) REFERENCES public.orders(id);


--
-- Name: replacement_requests replacement_requests_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_requests
    ADD CONSTRAINT replacement_requests_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;


--
-- Name: replacement_requests replacement_requests_processed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_requests
    ADD CONSTRAINT replacement_requests_processed_by_fkey FOREIGN KEY (processed_by) REFERENCES public.admin_users(id);


--
-- Name: replacement_requests replacement_requests_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacement_requests
    ADD CONSTRAINT replacement_requests_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: replacements replacements_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacements
    ADD CONSTRAINT replacements_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.admin_users(id);


--
-- Name: replacements replacements_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacements
    ADD CONSTRAINT replacements_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;


--
-- Name: replacements replacements_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.replacements
    ADD CONSTRAINT replacements_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: return_requests return_requests_processed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.return_requests
    ADD CONSTRAINT return_requests_processed_by_fkey FOREIGN KEY (processed_by) REFERENCES public.admin_users(id);
...
--
-- Name: returns returns_approved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.returns
    ADD CONSTRAINT returns_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.admin_users(id);
...
ALTER TABLE ONLY public.review
    ADD CONSTRAINT review_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.review
    ADD CONSTRAINT review_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
--
-- Name: FUNCTION decrement_helpful_count(review_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.decrement_helpful_count(review_id uuid) TO anon;
GRANT ALL ON FUNCTION public.decrement_helpful_count(review_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.decrement_helpful_count(review_id uuid) TO service_role;


--
-- Name: FUNCTION increment_helpful_count(review_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.increment_helpful_count(review_id uuid) TO anon;
GRANT ALL ON FUNCTION public.increment_helpful_count(review_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.increment_helpful_count(review_id uuid) TO service_role;


--
-- Name: FUNCTION update_product_rating(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_replacement_requests_updated_at(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_replacement_requests_updated_at() TO anon;
GRANT ALL ON FUNCTION public.update_replacement_requests_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.update_replacement_requests_updated_at() TO service_role;


--
-- Name: FUNCTION update_return_requests_updated_at(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_return_requests_updated_at() TO anon;
GRANT ALL ON FUNCTION public.update_return_requests_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.update_return_requests_updated_at() TO service_role;


--
-- Name: FUNCTION update_review_updated_at(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE deal_products; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE deal_products_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE helpful_reviews; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.helpful_reviews TO anon;
GRANT ALL ON TABLE public.helpful_reviews TO authenticated;
GRANT ALL ON TABLE public.helpful_reviews TO service_role;
...
--
-- Name: TABLE replacement_items; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.replacement_items TO anon;
GRANT ALL ON TABLE public.replacement_items TO authenticated;
GRANT ALL ON TABLE public.replacement_items TO service_role;


--
-- Name: TABLE replacement_requests; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE replacements; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict zmdIAvBHxo8I3pECfS7SqbpY62zo6EoE6mJhMztQ5w6EbB6aeWJJVGOA4OZ9GZS
